...
Formally, suppose we partition the parameter space $\Theta$ into two disjoin sets $\Theta_0$ and $\Theta_1$ and that we wish to test
...
The likelihood ratio test for $H_0: p = p_0 \quad \text{versus} \quad H_1: p \neq p_0$ is
